...
public class UserQuery {
    ...
    public static final String SELECT_EXPIRATION_DATE_BY_CODE_QUERY = "SELECT expiration_date < NOW() AS is_expired FROM TwoFactorVerifications WHERE code = :code";
    ...
    public static final String SELECT_EXPIRATION_DATE_BY_URL_QUERY = "SELECT expiration_date < NOW() AS is_expired FROM ResetPasswordVerifications WHERE url = :url";
    ...
    public static final String UPDATE_PASSWORD_BY_USER_ID_QUERY = "UPDATE Users SET password = :password WHERE id = :userId";
